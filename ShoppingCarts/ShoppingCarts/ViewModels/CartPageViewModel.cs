        ...
        private void ExecuteButtonClick(Object e)
        {
            ...
            try
            {
                ...
                if (selectedItem.Status)
                    ItemsList[index - 1].ButtonText = "Tambah Ke Keranjang";
                else
                    ItemsList[index - 1].ButtonText = "Hapus";
            ...
            try
            {
                ...
                for (int i = 0; i < ItemsList.Count; i++)
                {
                    if (ItemsList[i].Status)
                        ItemsList[i].ButtonText = "Hapus";
                    else
                        ItemsList[i].ButtonText = "Tambah Ke Keranjang";
                }
